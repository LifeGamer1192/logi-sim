...
export const GOODS = [
  ...
  { id: 'brick',    sell:  8, buy: 12, nameEn: 'Brick',    nameJa: 'レンガ' },
  { id: 'charcoal', sell:  8, buy: 12, nameEn: 'Charcoal', nameJa: '炭' },
  { id: 'iron',     sell: 10, buy: 15, nameEn: 'Iron',     nameJa: '鉄' },
  { id: 'copper',   sell: 10, buy: 15, nameEn: 'Copper',   nameJa: '銅' },
  { id: 'tin',      sell: 10, buy: 15, nameEn: 'Tin',      nameJa: 'スズ' },
  { id: 'bronze',   sell: 25, buy: 38, nameEn: 'Bronze',   nameJa: '青銅' },
  ...
  { id: 'rope',     sell:  8, buy: 12, nameEn: 'Rope',     nameJa: 'ロープ' },
  { id: 'cloth',    sell: 11, buy: 16, nameEn: 'Cloth',    nameJa: '布' },
  { id: 'leather',  sell:  7, buy: 11, nameEn: 'Leather',  nameJa: '革' },
  { id: 'grain',    sell:  3, buy:  5, nameEn: 'Grain',    nameJa: '穀物' },
  { id: 'flour',    sell:  8, buy: 12, nameEn: 'Flour',    nameJa: '小麦粉' },
  { id: 'tool',     sell: 32, buy: 48, nameEn: 'Tool',     nameJa: '道具' },
  { id: 'gear',     sell:100, buy:150, nameEn: 'Gear',     nameJa: '歯車' },
  ...
  { id: 'cottonCloth', sell: 35, buy: 52, nameEn: 'Cotton Cloth', nameJa: '木綿' },
  { id: 'canvas',      sell: 88, buy:132, nameEn: 'Canvas',       nameJa: '帆布' },
